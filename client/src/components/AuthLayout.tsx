...
export const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
    ...
    return (
        <div className="flex min-h-screen bg-[#0F172A] overflow-hidden text-[#F8FAFC]">
            ...
            >
                ...
                >
                    <div className="absolute top-[20%] left-[20%] w-96 h-96 bg-[#6366F1] rounded-full mix-blend-screen opacity-20 blur-[100px]" />
                ...
                <div className="relative z-10 flex flex-col items-center max-w-lg text-center">
                    ...
                    >
                        {/* Brain Core Glow */}
                        <div className="absolute inset-0 bg-[#6366F1] blur-[60px] opacity-40 rounded-full scale-75 animate-pulse" />

                        {/* Stylized Node Network representing a brain */}
                        <svg viewBox="0 0 200 200" className="w-full h-full text-[#6366F1]">
                            <motion.path
                    ...
                    >
                        Your digital <span className="text-[#6366F1]">Second Brain</span>
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        className="text-lg text-slate-400 max-w-md mx-auto leading-relaxed"
                    >
            ...
            <div className="flex w-full lg:w-1/2 items-center justify-center p-6 sm:p-12 relative z-20">
                ...
                <div className="lg:hidden absolute inset-0 bg-[#0F172A] z-0 pointer-events-none">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-[#6366F1] rounded-full mix-blend-screen opacity-10 blur-[80px]" />
                </div>

                <div className="w-full max-w-md relative z-10">
                    {/* Mobile App Logo */}
                    <div className="lg:hidden flex items-center justify-center mb-8">
                        <div className="w-12 h-12 rounded-xl bg-[#1E293B] border border-[#2D3748] flex items-center justify-center shadow-lg">
                            <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 text-[#6366F1]">
                        ...
                        <span className="ml-3 text-2xl font-bold" style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif" }}>Second Brain</span>
                    </div>
                    ...
                    <motion.div
                        ...
                        className="bg-[#1E293B] p-8 rounded-2xl border border-slate-800 shadow-2xl overflow-hidden"
                    >
                        {children}
                    </motion.div>
                </div>
