...
const fixIndexes = async () => {
    try {
        ...
        // Note: The correct compound index title_1_userId_1 is defined in the Mongoose schema 
        // and will be created automatically by Mongoose upon app restart/insertion if missing.
